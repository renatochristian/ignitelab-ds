...
export function App() {
	return (
		<div className="flex flex-col my-16 2xl:my-0 w-full 2xl:w-screen h-full 2xl:h-screen items-center justify-center text-gray-100">
			...
			<footer className="mt-8 flex flex-col gap-2 items-center">
				<Text asChild size="sm" className="text-gray-400 underline">
